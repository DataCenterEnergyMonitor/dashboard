...
def create_energy_reporting_heatmap(
    ...
    legend_items = {
        ...
        'Company Wide Electricity Use': REPORTING_SCOPE_COLORS['Company Wide Electricity Use'],
        'Data Center Fuel Use': REPORTING_SCOPE_COLORS['Data Center Fuel Use'],
        'Data Center Electricity Use': REPORTING_SCOPE_COLORS['Data Center Electricity Use'],
    }
