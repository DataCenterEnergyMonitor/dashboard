...
def register_rt_tab4_callbacks(app, pue_wue_companies_df):
    ...
    @app.callback(
        Output("rt-fig4-container", "children"),
        [
    ...
    def update_rt_tab4_chart(filter_data, active_tab):
        ...
        # Create PUE Trends header chart (sticky header with legend and x-axis)
    ...
    @app.callback(
        ...
        [
            ...
            State("rt-tab4-fig1", "figure"),
        ],
        prevent_initial_call=True,
    )
    def toggle_rt_tab4_modal(expand_clicks, is_open, current_figure):
        ...
        if last_modified_date:
            modal_title = html.Div(
                [
                    html.Div("PUE Reporting by Company Over Time - Expanded View"),
                    html.Div(
                        f"(as of {last_modified_date})",
                        style={
                            "fontSize": "0.85em",
            ...
            modal_title = "PUE Reporting by Company Over Time - Expanded View"
