        ...
        html.Div([
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Label("Publisher institution type(s):", className="filter-label"),
                    dcc.Dropdown(
                        id='publisher_institution_types', 
                        options=sorted(df['citation'].unique()), 
                        multi=True, 
                        persistence=True,
                        persistence_type="session",
                    ...
                    html.Label("Author institution type(s):", className="filter-label"),
                    dcc.Dropdown(
                        id='author_institution_types', 
                        options=sorted(df['citation'].unique()), 
                        multi=True, 
                        persistence=True,
                        persistence_type="session",
                    ...
                    html.Label("Study Region:", className="filter-label"),
                    dcc.Dropdown(
                        id='region', 
                        options=[], 
                        multi=True, 
                    ...
                    html.Label("Data center type(s):", className="filter-label"),
                    dcc.Dropdown(
                        id='data_center_types', 
                        options=[], 
                        multi=True, 
                    ...
                    html.Label("Associated granularity:", className="filter-label"),
                    dcc.Dropdown(
                    ...
                    html.Label("Modeling approach(es):", className="filter-label"),
                    dcc.Dropdown(
                        id='modeling_approaches', 
                        options=[], 
                        multi=True, 
                    ...
                    html.Label("Input data type(s):", className="filter-label"),
                    dcc.Dropdown(
                        id='input_data_types', 
                        options=[], 
                        multi=True, 
                    ...
                    html.Label("Time horizon:", className="filter-label"),
                    dcc.Dropdown(
                        id='time_horizon', 
                        options=[], 
                        multi=True, 
                    ...
                    html.Label("Projection narrative:", className="filter-label"),
                    dcc.Dropdown(
                        id='projection_narrative', 
                        options=[], 
                        multi=True, 
                    ...
                    html.Label(["Overall Quality Rating:",
                               dbc.Tooltip(
                ...
                html.Div([
                    ...
                    html.Label(["Uncertainty quantification:",
                               dbc.Tooltip(
                    ...
                    html.Label(["Technological Correlation:",
                               dbc.Tooltip(
                    ...
                    html.Label(["Geographical Correlation:",
                               dbc.Tooltip(
                    ...
                    html.Label(["Temporal Correlation:",
                               dbc.Tooltip(
