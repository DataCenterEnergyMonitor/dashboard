...
def create_water_projections_filters(df):
    return html.Div(
        [
            # Sidebar container
            html.Div(
                        ...
                        [
                            ...
                            html.Div(
                                [
                                    ...
                                    dcc.Dropdown(
                                        id="wp_publisher_institution_type_s_",
                                        options=[],
                                        multi=True,
                                        persistence=True,
                                        persistence_type="session",
                                    ...
                                    dcc.Dropdown(
                                        id="wp_author_institution_type_s_",
                            ...
                            html.Div(
                                [
                                    ...
                                    dcc.Checklist(
                                        id="wp_uncertainty_quantification",
                                        options=["1", "2", "3"],
                                        value=[],
                                        persistence=True,
                                        persistence_type="session",
                                    ...
                                    html.Label(
                                        [
                                            ...
                                            dbc.Tooltip(
                                                html.Div(
                                                    [
                                                        "How detailed is the approach and reporting such that water demand drivers are isolated and transparent?",
                                                        html.Br(),
                                                        html.Br(),
                                                        html.Strong("1:"),
                                    ...
                                    dcc.Checklist(
                                        id="wp_geographical_correlation",
                                        options=["1", "2", "3"],
                                        value=[],
                                        persistence=True,
                                        persistence_type="session",
