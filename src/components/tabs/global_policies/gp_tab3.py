...
from components.filters.global_policies.gp_tab3_filters import create_gp_tab3_filters
...
def create_gp_tab3(app, gp_transposed_df):
    content = html.Div(
        [
            # Sticky sidebar wrapper
            create_gp_tab3_filters(gp_transposed_df),
            html.Div(
                [
            ...
            dbc.Modal(
                [
                    dbc.ModalHeader(dbc.ModalTitle(id="gp-map-modal-title")),
                    dbc.ModalBody(
                        [
                            dcc.Graph(
                                id="gp-map-expanded-graph",
                                style={
