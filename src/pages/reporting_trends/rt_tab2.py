...
from components.filters.reporting_trends.rt_tab2_filters import (
...
def create_rt_tab2(app, reporting_df):
    ...
    content = html.Div(
        [
            ...
            create_rt_tab2_filters(reporting_df),
            html.Div(
                [
                    # Mobile navigation
                    html.Div(
            ...
            dbc.Modal(
                [
                    dbc.ModalHeader(dbc.ModalTitle(id="rt-fig2-modal-title")),
                    dbc.ModalBody(
                        [
                            dcc.Graph(
                                id="rt-fig2-expanded",
